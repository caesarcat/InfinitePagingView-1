...
class InfinitePagingView: UIView, UIScrollViewDelegate {
    ...
    var delegate: InfinitePagingViewDelegate?
    ...
    var scrollDirection: InfinitePagingViewScrollDirection!
    ...
    func scrollToPreviousPage() {
        self.scrollToDirection(1, animated: true)
        var timer = NSTimer.scheduledTimerWithTimeInterval(0.5, target: innerScrollView, selector: Selector("scrollViewDidEndDecelerating"), userInfo: nil, repeats: false)
    }
